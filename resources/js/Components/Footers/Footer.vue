          ...
          <div class="flex flex-wrap items-top mb-6">
            <div class="w-full lg:w-4/12 px-4 ml-auto">
              ...
              <ul class="list-unstyled">
                <li>
                  <a
                    class="text-blueGray-200 hover:text-blueGray-300 font-semibold block pb-2 text-sm"
                ...
                <li>
                  <a
                    class="text-blueGray-600 hover:text-blueGray-200 font-semibold block pb-2 text-sm"
